...
function copyFiles(pkg) {
  ...
  const dest = Path.join("docs", "src", "content", "docs", "api", pkg)
...
packages().forEach((pkg, i) => {
  Fs.rmSync(Path.join("docs", "src", "content", "docs", "api", pkg), { recursive: true, force: true })
  Fs.mkdirSync(Path.join("docs", "src", "content", "docs", "api", pkg), { recursive: true })
  copyFiles(pkg)
})
